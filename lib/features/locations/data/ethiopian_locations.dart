...
class EthiopianLocations {
  static List<Location> get all => [
    ...
    const Location(
      ...
      description: 'UNESCO World Heritage site featuring 36 decorated standing stones (stelae) from the 12th-14th centuries, with mysterious engravings and symbols.',
      category: 'Historical',
      imageUrl: 'assets/images/Axum.png',
      latitude: 8.4500,
      longitude: 38.6167,
      ...
      isOpen: true,
      isFavorite: false,
      tags: ['UNESCO World Heritage', 'Ancient Monuments', 'Archaeology', 'Mystery'],
      facilities: ['Visitor Center', 'Guided Tours', 'Museum'],
      phone: '+251-11-445-0789',
      address: 'Gurage Zone, Southern Nations Region, Ethiopia',
    ),

    const Location(
      id: 'yeha-temple',
      name: 'Yeha Temple',
      description: 'The oldest standing structure in Ethiopia, dating back to around 500 BC. A pre-Axumite temple showcasing ancient South Arabian architectural influence.',
      category: 'Historical',
      imageUrl: 'assets/images/Axum.png',
      latitude: 14.2833,
      longitude: 39.0167,
      ...
      isOpen: true,
      isFavorite: false,
      tags: ['Ancient Architecture', 'Pre-Axumite', 'Archaeological Site', 'Historical Monument'],
      facilities: ['Local Guides', 'Archaeological Display'],
      phone: '+251-34-445-0234',
      address: 'Yeha, Tigray Region, Ethiopia',
    ),

    const Location(
      id: 'abuna-yemata-guh',
      name: 'Abuna Yemata Guh Church',
      description: 'One of the most inaccessible churches in the world, carved into a cliff face at 2,580m. Requires rock climbing to reach but rewards with stunning frescoes.',
      category: 'Religious',
      imageUrl: 'assets/images/debre damo.png',
      latitude: 13.7667,
      longitude: 39.3167,
      rating: 4.8,
      reviewCount: 187,
      price: 'Guide fee required',
      openingHours: '7:00 AM - 4:00 PM',
      isOpen: true,
      isFavorite: false,
      tags: ['Rock Church', 'Cliff Climbing', 'Ancient Frescoes', 'Adventure', 'Unique Access'],
      facilities: ['Climbing Guides', 'Safety Equipment'],
      phone: '+251-34-445-0345',
      address: 'Hawzen, Tigray Region, Ethiopia',
    ),

    const Location(
      id: 'bete-amanuel',
      name: 'Bete Amanuel (House of Emmanuel)',
      description: 'One of the rock-hewn churches of Lalibela, carved to resemble an Axumite palace with distinctive multi-story design.',
      category: 'Religious',
      imageUrl: 'assets/images/Lalibela.png',
      latitude: 12.0325,
      longitude: 39.0475,
      rating: 4.7,
      reviewCount: 156,
      price: 'Included in Lalibela site ticket',
      openingHours: '6:00 AM - 6:00 PM',
      isOpen: true,
      isFavorite: false,
      tags: ['Rock-Hewn Church', 'UNESCO World Heritage', 'Lalibela Complex', 'Architecture'],
      facilities: ['Local Guides', 'Religious Services'],
      phone: '+251-33-336-0001',
      address: 'Lalibela, Amhara Region, Ethiopia',
    ),
    ...
    const Location(
      ...
      description: 'Home to diverse indigenous tribes maintaining traditional lifestyles. Experience unique cultures, ceremonies, and authentic African tribal heritage.',
      category: 'Cultural',
      imageUrl: 'assets/images/konso.png',
      latitude: 5.4333,
      longitude: 36.5667,
      rating: 4.6,
      reviewCount: 234,
      price: 'Village fees + Guide',
      openingHours: 'Day visits only',
      isOpen: true,
      isFavorite: false,
      tags: ['Indigenous Tribes', 'Cultural Heritage', 'Traditional Lifestyle', 'Photography', 'Anthropology'],
      facilities: ['Cultural Guides', 'Village Tours', 'Accommodation'],
      phone: '+251-46-775-0567',
      address: 'Omo Valley, Southern Nations Region, Ethiopia',
    ),

    const Location(
      id: 'awash-national-park',
      name: 'Awash National Park',
      description: 'Ethiopia\'s oldest national park featuring the stunning Awash Falls, diverse wildlife including oryx and baboons, and spectacular volcanic landscapes.',
      category: 'Nature',
      imageUrl: 'assets/images/Bale.png',
      latitude: 8.9167,
      longitude: 40.0000,
      ...
      isOpen: true,
      isFavorite: false,
      tags: ['Wildlife', 'Waterfalls', 'Volcanic Landscape', 'Safari', 'Bird Watching'],
      facilities: ['Safari Tours', 'Camping', 'Ranger Station', 'Lodges'],
      website: 'https://ethiopia.travel/destinations/awash-national-park/',
      phone: '+251-22-117-0456',
      address: 'Awash, Afar Region, Ethiopia',
    ),

    const Location(
      id: 'sof-omar-caves',
      name: 'Sof Omar Caves',
      description: 'Spectacular natural limestone caves formed by the Web River. One of the longest cave systems in Africa with stunning rock formations.',
      category: 'Nature',
      imageUrl: 'assets/images/Danakil.png',
      latitude: 6.9167,
      longitude: 40.8500,
      ...
      isOpen: true,
      isFavorite: false,
      tags: ['Cave System', 'Limestone Formations', 'Underground River', 'Geology', 'Adventure'],
      facilities: ['Cave Guides', 'Lighting', 'Safety Equipment'],
      phone: '+251-22-117-0678',
      address: 'Bale Zone, Oromia Region, Ethiopia',
    ),
    ...
    const Location(
      ...
      description: 'Historic mountain range overlooking Addis Ababa, site of Emperor Menelik II\'s palace and panoramic city views.',
      category: 'Historical',
      imageUrl: 'assets/images/Bale.png',
      latitude: 9.0667,
      longitude: 38.7667,
      rating: 4.2,
      reviewCount: 412,
      price: 'Free (Museum fees apply)',
      openingHours: '8:00 AM - 6:00 PM',
      isOpen: true,
      isFavorite: false,
      tags: ['Mountain Views', 'Historical Palace', 'Eucalyptus Forests', 'Hiking', 'City Views'],
      facilities: ['Museums', 'Viewpoints', 'Hiking Trails', 'Church'],
      phone: '+251-11-557-0234',
      address: 'Addis Ababa, Ethiopia',
    ),

    const Location(
      id: 'adadi-mariam',
      name: 'Adadi Mariam Rock Church',
      description: 'Rock-hewn church south of Addis Ababa, believed to be carved by King Lalibela. Features beautiful frescoes and similar architecture to Lalibela churches.',
      category: 'Religious',
      imageUrl: 'assets/images/Lalibela.png',
      latitude: 8.7833,
      longitude: 38.7167,
      ...
      isOpen: true,
      isFavorite: false,
      tags: ['Rock Church', 'Historical Monument', 'Frescoes', 'Religious Site'],
      facilities: ['Local Guides', 'Parking'],
      phone: '+251-11-445-0890',
      address: 'Tulu Dimtu, Oromia Region, Ethiopia',
    ),
  ];
